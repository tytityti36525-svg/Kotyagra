...
function render(){
  ...
  {const sc=$('season-chip');if(sc){const si=seasonInfo();sc.innerHTML='<span class="sch-ic">'+si.icon+'</span><span class="sch-txt"><b>'+si.name+'</b> · '+si.desc+'</span>';}}
...
function renderMerchant(){
  ...
  card.innerHTML='<div class="merch-head"><span class="merch-cat">🧙</span><div><div class="merch-title">Таємничий торговець</div><div class="merch-sub">Заглядає раз на день…</div></div></div>'
