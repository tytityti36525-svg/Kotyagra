...
window.goPage=function(id){
  ...
  if(id==='settings'&&typeof refreshInstallUI==='function')refreshInstallUI();
...
function trainCost(lv){return 25+lv*5;} // прогресія: 25, 30, 35 ... 420 (рів.79)
...
const SHOP={
  ...
  clothes:[
    ...
    {id:'w_hat2',  icon:'👑',name:'Корона', cost:550,wear:true,slot:'hat',beauty:18},
    {id:'w_diadem',icon:'👸',name:'Діадема', cost:1400,wear:true,slot:'hat',beauty:26},
...
function houseUpCost(lv){return Math.round(90*Math.pow(1.7,lv));} // геометрія: 90,153,260,442,752,1278,2173,3694,6280,10676
...
window.fishingAction=function(){
  ...
  if(c.ing){if(!P.ingredients)P.ingredients={};P.ingredients[c.ing]=(P.ingredients[c.ing]||0)+1;parts.push('🍳 інгредієнт');}
...
function gardenPlotCost(){const n=P.garden.plots.length;return n<=3?800:(n===4?2000:4000);} // 4-та 800, 5-та 2000, 6-та 4000
