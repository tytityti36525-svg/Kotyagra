...
window.goPage=function(id){
  ...
  if(id==='home'){if(typeof updateWeatherUI==='function')updateWeatherUI();if(typeof updateSeasonUI==='function')updateSeasonUI();}
...
async function loadClubData(){
  ...
  try{
    ...
    if(piggyNote)piggyNote.textContent=isDirector?'Ви Директор — можете будувати постройки за кошти скарбнички.':'Поповнюйте скарбничку — це дає вам особистий бонус досвіду та вірність клубу.';
...
const SHOP={
  ...
  clothes:[
    ...
    {id:'w_dress', icon:'👗',name:'Сукня',  cost:200,wear:true,slot:'shirt',beauty:10},
  ...
  accessories:[
    ...
    {id:'a_ring',  icon:'💍',name:'Кільце',    cost:160,wear:true,slot:'ring',beauty:9},
...
function renderWorkshop(){
  ...
  if(mat){
    const gemList=GEMS.map(g=>['🔴🔵🟢🟡⚪'[GEMS.indexOf(g)]||'💎',g.key,(P.gems&&P.gems[g.key])||0]);
