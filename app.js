...
const FISH_CATCH=[
  ...
  {icon:'🐟',name:'Карась',      cMin:15,cMax:30,    w:26, ing:'karas'},
  {icon:'🐠',name:'Окунь',       cMin:35,cMax:60,    w:22, ing:'okun'},
  {icon:'🐡',name:'Короп',       cMin:60,cMax:100,   w:16, ing:'korop'},
  {icon:'🦐',name:'Креветка',    bf:5,               w:9,  ing:'shrimp'},
  {icon:'🦈',name:'Рідкісна рибина',cMin:120,cMax:200,bf:5,w:7, ing:'rare'},
