...
function mkPlayer(nickname,catname,petType='cat'){
  return{
    ...
    riddleDay:'',rouletteDay:'',rouletteSpins:0,loginCal:{streak:0,last:'',claimed:[]},music:false,crystals:0,
    landmarks:{},title:'',
...
function renderGames(){renderRiddle();renderRoulette();renderMemory();}
